...
?>
<h1><i class="fas fa-plus-circle"></i> Nouveau dépôt</h1>
<section class="card">
    <form id="depot-form" data-mode="create">
        <div class="form-row">
            <label>Nom
        ...
        <div class="form-row">
            <label><input type="checkbox" id="dep-main"> Définir comme dépôt principal</label>
        </div>
        <div class="form-row">
